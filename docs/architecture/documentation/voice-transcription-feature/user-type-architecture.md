...
This architecture specifically implements:
- **[Epic 2](./epics.json)**: User Type Management & Quota System
  - [User Type Detection System](./user-stories.json)
  - [Quota Tracking Infrastructure](./user-stories.json)
  - [Policy Engine Implementation](./user-stories.json)
  - [Premium User Experience](./user-stories.json)

Integration with:
- **[Epic 1](./epics.json)**: Core Infrastructure (for base functionality)
- **[Epic 3](./epics.json)**: High-Level API (for user-facing methods)
...
### 1. User Type Manager
**Implements**: [User Story - User Type Detection System](./user-stories.json) (Epic 2)
...
**Implements**: [User Story - Policy Engine Implementation](./user-stories.json) (Epic 2)
...
- [User Story - Integration with Core Infrastructure](./user-stories.json) (Epic 2)
...
**Implements**:
- [User Story - Premium User Experience](./user-stories.json) (Epic 2)
...
### 1. Quota Prediction
**Implements**: [User Story - Usage Prediction and Warnings](./user-stories.json) (Epic 2)
...
**Implements**: [User Story - Supergroup Boost Integration](./user-stories.json) (Epic 4)
...
**Implements**: [User Story - External STT Fallback System](./user-stories.json) (Epic 4)
